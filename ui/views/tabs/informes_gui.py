...
from ui.views.constants import FONT_BODY, PAD_X, PAD_Y, TEACHERS
from ui.views.helpers_gui import create_label_combobox, create_label_frame
...
class ReportsTab:
    ...
    def calculate_salary(self):
        ...
        try:
            ...
            report = self.main_service.cqrs.get_salary(prof_name)
