...
class RestoreBackupDialog:
    def __init__(self, parent: ttk.Window, service: ServiceContainer):
    ...
    def _load_backups(self):
        ...
        self.backup_files = self.service.maintenance.list_backup_files()
    ...
    def _restore_selected(self):
        ...
        try:
            ...
            success = self.service.maintenance.restore_backup(selected_file)
