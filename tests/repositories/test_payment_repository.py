...
def test_payment_persisted(db: DatabaseManager):
    ...
    with mov_repo.db_manager.transaction() as conn:
        ...
        movement = Movement(student_id=student.id, type="PAYMENT", amount=100, month=3, year=2026)
